...
<div align="center">
  <a href="https://github.com/Mromano06/Group14_Section1_JackBlackBlackJack">
    <img width="640" height="360" alt="Balckjack_logo" src="https://github.com/user-attachments/assets/b2a1a8dc-ed33-4570-9e70-cabdb919e6e9" />
  </a>

<h3 align="center">Group14_Section1_JackBlackBlackJack</h3>

  <p align="center">
    A blackjack game that will allow for single and multiplayer
    <br />
...
Here's a blank template to get started. To avoid retyping too much info, do a search and replace with your text editor for the following: `Mromano06`, `Group14_Section1_JackBlackBlackJack`, `twitter_handle`, `linkedin_username`, `email_client`, `email`, `Group14_Section1_JackBlackBlackJack`, `A blackjack game that will allow for single and multiplayer`, `project_license`
...
5. Change git remote url to avoid accidental pushes to base project
   ```sh
   git remote set-url origin Mromano06/Group14_Section1_JackBlackBlackJack
